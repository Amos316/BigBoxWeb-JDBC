...
<body>
    ...
    <form action="AddstoresServlet" method="post">
        ...
        <input type="text" name="divisionID" value="${store.divNumber}" 
               required><br>
        <label class="pad_top">Store Number:</label>
        <input type="text" name="StoreNumber" value="${store.storeNbr}" 
               required><br>
        <label class="pad_top">sales:</label>
        <input type="text" name="sales" value="${store.sales2}" required><br>   
        ...
        <input type="text" name="zip" value="${store.zipCode}"  
               required><br>                                 
